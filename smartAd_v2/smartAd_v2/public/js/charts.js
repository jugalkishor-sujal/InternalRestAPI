...
/*				legends.eq(i).text(series.label.replace(/=.*//*, "= " + y.toFixed(2)));
    ...
    */
    ...
    var piedata = [
        { label: "Kiosk", data: [[1,10]], color: '#D9534F'},
        { label: "E-Kiosk", data: [[1,30]], color: '#1CAF9A'},
        { label: "Space B", data: [[1,90]], color: '#F0AD4E'},
        { label: "WiFi", data: [[1,70]], color: '#428BCA'},
        { label: "Beacon", data: [[1,80]], color: '#5BC0DE'}
	 ];
   ...
   */
    ...
    */
    new Morris.Donut({
        ...
        data: [
        {label: "GuangZhou", value: 30},
        {label: "Shanghai", value: 20},
        {label: "Xiamen", value: 20},
        {label: "Shenzhen", value: 20},
